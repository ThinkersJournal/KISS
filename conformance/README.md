...
**383<!-- bound:harness --> of 939<!-- bound:clauses --> normative clauses are
...
The remaining 556<!-- bound:unbacked_total --> are listed in [`UNBACKED.tsv`](UNBACKED.tsv), and they are not one
population: **497<!-- bound:untested_rows --> genuinely untested**, 33 enforced by a
...
the harness one for exactly this reason. Of this crate's 558<!-- bound:test_fns --> test fns, **134<!-- bound:uncited_tests --> cite
...
- **Phase 6 — burn down `UNBACKED.tsv`.** 556<!-- bound:unbacked_total --> clauses, no executable test. Order
